				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12 text-white" style="background: #4682B4;">
							...
							<form action="<?php echo base_url(); ?>pegawai/PermohonanCuti/cutiSakit" method="POST" enctype="multipart/form-data">
...
<script>
	$(document).ready(function() {
		$('#berakhir').change(function() {
			...
			if (diffDays > 14) {
				alert('Periode tanggal tidak boleh lebih dari 14 hari!');
...
<!-- Menghitung waktu mundur yang tersisa -->
