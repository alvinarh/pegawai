    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="background: #fff;">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background: #4682B4;">
                <a class="navbar-brand brand-logo " style="width:15%;" href=""><img src="<?php echo base_url() ?>/assets/jawatengah1.png ?>" alt="logo" style="width:20px; height:20px; margin-right:5spx; " /></a>
                <h4 class="card-title text-white m-0">Sistem Cuti Pegawai</h4>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background: #4682B4;">
                ...
                <br> </br>
                    ...
                    <li class="nav-item <?php if($d){echo $a;} ?>">
                        <a class="nav-link" href="<?php echo base_url('pimpinan/dashboard') ?>">
                            <span class="menu-title text-white">Dashboard</span>
                            <i class="mdi mdi-home menu-icon text-white"></i>
                        </a>
                    </li>
                    
                    <li class="nav-item <?php if($pp){echo $a;} ?>">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/Cuti/cutiSakit') ?>">Cuti Sakit <= 14 Hari</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/Cuti/cutiSakit14') ?>">Cuti Sakit > 14 Hari</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/Cuti/cutiMelahirkan') ?>">Cuti Melahirkan</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/Cuti/cutiAlasanPenting') ?>">Cuti Alasan Penting</a></li>
                            </ul>
                        </div>
                    </li>

                    <li class="nav-item <?php if($lp){echo $a;} ?>">
                        ...
                        <div class="collapse" id="ui-basic3">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/LaporanCuti/cutiSakit') ?>">Cuti Sakit <= 14 Hari</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/LaporanCuti/cutiSakit14') ?>">Cuti Sakit > 14 Hari</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/LaporanCuti/cutiMelahirkan') ?>">Cuti Melahirkan</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pimpinan/LaporanCuti/cutiAlasanPenting') ?>">Cuti Alasan Penting</a></li>
                            </ul>
                        </div>
                    </li>
